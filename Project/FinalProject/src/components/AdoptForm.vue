    ...
    <div class="main-container">
        ...
        <div class="container">
            <div class="content">
                ...
                <div class="item-1">
                    <h2>How You Can Adopt</h2>
                    <li>Fill The Form </li>
                    <li>Select A type of Animal</li>
                    <li>Please Provide Your Real Details. We take care about Your Privacy</li>
                    <li>We Will Contact You After you request for Adoption</li>
                    <li>Our Team Come to Your place and check everything and take a signature in condition of adoption form</li>
                    <li>After completing All process you will be the owner of that animal</li>
                </div>
            </div>
            <form @submit.prevent="handleSubmit">
                ...
                <div class="address">
                    <input id="state" v-model="state" name="state" type="text" placeholder="State">
                    <input id="city" v-model="city" name="city" type="text" placeholder="City">
                    <input id="area" v-model="area" name="area" type="text" placeholder="Area">
                    <input id="street" v-model="street" name="street" type="text" placeholder="Street">
                    <input id="landmark" v-model="landmark" name="landmark" type="text" placeholder="Landmark">
                </div>
...
export default {
    ...
    methods: {
        handleSubmit(){
            axios.post("http://localhost:8080/adopt/request", {
